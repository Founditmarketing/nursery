                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
                    <div className="lg:col-span-2">
                        ...
                        <div className="flex gap-4">
                            <a href="https://www.facebook.com/rsrnursery" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border border-stone-800 flex items-center justify-center hover:bg-emerald-800 hover:border-emerald-700 hover:text-white transition-all duration-300">
