...
export default function Inventory() {
    const categories = [
        { name: 'Azaleas', img: 'https://images.unsplash.com/photo-1586375063704-585866418b76?q=80&w=1974&auto=format&fit=crop' },
        ...
        { name: 'Trees', img: 'https://images.unsplash.com/photo-1513836279014-a89f7a76ae86?q=80&w=1976&auto=format&fit=crop' },
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
                    {categories.map((category, index) => (
                        <motion.a
                            ...
                            className="group relative h-80 rounded-[2rem] overflow-hidden block shadow-sm hover:shadow-2xl transition-all duration-500"
                        >
                            <img
                                src={category.img}
                                alt={category.name}
                            ...
                            />
                            <div className="absolute inset-0 bg-gradient-to-t from-stone-950/90 via-stone-900/20 to-transparent transition-opacity duration-500 opacity-80 group-hover:opacity-100" />
                            <div className="absolute inset-0 flex flex-col justify-end p-8">
                                <div className="flex items-center justify-between z-10">
                                    <h4 className="text-white font-medium text-xl tracking-wide group-hover:-translate-y-1 transition-transform duration-500">
                                        {category.name}
                                    </h4>
